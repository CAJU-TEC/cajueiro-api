...
// corporates
Route::get('comments', CommentsIndexController::class)->name('index')->middleware(['role_or_permission:super-admin|comments.index']);
// Route::get('corporates/{corporate}', CorporateShowController::class)->name('show');
Route::post('comments', CommentsStoreController::class)->name('store')->middleware(['role_or_permission:super-admin|comments.store']);
